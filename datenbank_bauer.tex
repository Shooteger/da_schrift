...
\bauer
	...
	\section{Datenbankentwurf}
		...
		\subsection{NoSQL Datenbankentwurf}
			...
			Weshalb in diesem Absatz genauer darauf eingegangen wie der Entwurf der EMS Datenbank vorgenommen wurde. 
			Da unser Team sich für die MongoDB entschieden hat musste der komplette Entwurf nicht vollständig abgeschlossen sein bevor mit der Entwicklung begonnen wurde. 
			Trotzdem wollten uns Team von Anfang an einen grundsätzliches Schema festlegen bevor die Entwicklung begonnen hat.
