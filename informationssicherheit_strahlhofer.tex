...
%Einzige Information Token, dem Fremdzugriff keine personen bezogenen Daten erfährt
...
%Ist dadurch gegeben das nur eine bestimmte Person Zugriff auf die Datenbank besitzt
...
%sollte durch cloud services available sein, ist aber nicht da aws ned gezahlt werden will
...
%das es mit einem secret key verschlüsselt wird
