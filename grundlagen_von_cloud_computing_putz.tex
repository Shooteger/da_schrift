...
Bei einer privaten Cloud gibt es verschiedene Evolutionsstufen, welche die Wichitgkeit 
...
\begin{itemize}
	...
	\item Open Cloud: In der Regel kennen sich der Benutzer/Kunde und Cloudanbieter nicht. In sogenannten \textbf{"`Service Level Agreements"'}, oder kurz SSL, werden die Leistungen und die Vergütung jeder genauestens beschrieben. Hier laufen Vertragsabschluss und Nutzung voll- oder semiautomatisiert ab, da die Anzahl der Nutzer bei dieser Form der öffentlichen Cloud viel höher als bei allen anderen ist.
...
Das Backend der fertigen Anwendung, besteht aus den Technologien Node.Js und Express und dieses verbindet sich mit einer externen MongoDB Datenbank in der Atlassian Cloud(siehe Kapitel 5.1.4). Grundsätzlich war geplant, dieses in der AWS Cloud unter Amazon Lightsail oder dem EC2 Service zu hosten. 
