...
\bauer	
	\section{Data Analytics}	
		...
		\subsection{Definition} \footcite{data-analysis}
			Data Analytics ist ein Prozess bei dem Daten inspiziert, gereinigt, verwandelt und modelliert werden, um neue nützliche Informationen zu bekommen. 
		...
		\subsection{Analyse Methoden} \footcite{analyse-methode}
			\subsubsection{Qualitative Analyse}
				In der Qualitative Analyse werden die Fragen 'wie?', 'was?' und 'warum?' gelärt, indem quantitative Techniken angewendet werden, wie Fragebögen oder Einstellungsskalierungen. 
